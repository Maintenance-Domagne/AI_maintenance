...
('pc','Matériel','Le bouton d\'alimentation ne fonctionne pas','bouton ne fonctionne pas,power,click','Vérifiez le câble du bouton d\'alimentation|Testez avec un autre périphérique d\'entrée|Redémarrez le PC et testez à nouveau',2),
('serveur','Réseau','La connexion au serveur est lente','connexion lente,slow,lag','Vérifiez la charge du serveur|Redémarrez les services réseau|Contrôlez la bande passante et les logs du serveur',2);
GO